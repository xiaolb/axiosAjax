...
var f$c = function getOwnPropertyNames(it) {
  return windowNames$1 && toString$3.call(it) == '[object Window]' ? getWindowNames$1(it) : nativeGetOwnPropertyNames$2(toIndexedObject$1(it));
};
...
var wellKnownSymbol$1 = function (name) {
  return store$3[name] || (store$3[name] = nativeSymbol$1 && Symbol$2[name] || (nativeSymbol$1 ? Symbol$2 : uid$1)('Symbol.' + name));
};
...
var SPECIES$4 = wellKnownSymbol$1('species'); // `ArraySpeciesCreate` abstract operation
// https://tc39.github.io/ecma262/#sec-arrayspeciescreate
...
var arraySpeciesCreate$1 = function (originalArray, length) {
  ...
  if (isArray$3(originalArray)) {
    ...
    if (typeof C == 'function' && (C === Array || isArray$3(C.prototype))) { C = undefined; }else if (isObject$1(C)) {
      C = C[SPECIES$4];
      if (C === null) { C = undefined; }
    }
  }
...
var setSymbolDescriptor$1 = descriptors$1 && fails$1(function () {
  return objectCreate$1(nativeDefineProperty$3({}, 'a', {
    get: function () {
      return nativeDefineProperty$3(this, 'a', {
        value: 7
      }).a;
    }
  })).a != 7;
}) ? function (O, P, Attributes) {
  var ObjectPrototypeDescriptor = nativeGetOwnPropertyDescriptor$4(ObjectPrototype$2, P);
...
var $defineProperty$1 = function defineProperty(O, P, Attributes) {
  ...
  if (has$5(AllSymbols$1, key)) {
    if (!Attributes.enumerable) {
      if (!has$5(O, HIDDEN$1)) { nativeDefineProperty$3(O, HIDDEN$1, createPropertyDescriptor$1(1, {})); }
      O[HIDDEN$1][key] = true;
    } else {
...
JSON$2 && _export$1({
  target: 'JSON',
  stat: true,
  forced: !nativeSymbol$1 || fails$1(function () {
    var symbol = $Symbol$1(); // MS Edge converts symbol values to JSON as {}

    return nativeJSONStringify$1([symbol]) != '[null]' // WebKit converts symbol values to JSON as null
    || nativeJSONStringify$1({
      a: symbol
    }) != '{}' // V8 throws on boxed symbols
...
if (!$Symbol$1[PROTOTYPE$3][TO_PRIMITIVE$1]) { hide$1($Symbol$1[PROTOTYPE$3], TO_PRIMITIVE$1, $Symbol$1[PROTOTYPE$3].valueOf); } // `Symbol.prototype[@@toStringTag]` property
// https://tc39.github.io/ecma262/#sec-symbol.prototype-@@tostringtag
...
if ( !has$5(IteratorPrototype$3, ITERATOR$7)) { hide$1(IteratorPrototype$3, ITERATOR$7, returnThis$3); }
var iteratorsCore$1 = {
...
var defineIterator$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    if (IteratorPrototype$5 !== Object.prototype && CurrentIteratorPrototype.next) {
      if ( objectGetPrototypeOf$1(CurrentIteratorPrototype) !== IteratorPrototype$5) {
        if (objectSetPrototypeOf$1) {
          ...
          hide$1(CurrentIteratorPrototype, ITERATOR$8, returnThis$4);
        }
      } // Set @@toStringTag to native iterators
  ...
  if ( IterablePrototype[ITERATOR$8] !== defaultIterator) {
    hide$1(IterablePrototype, ITERATOR$8, defaultIterator);
  }
...
var getOwnPropertyDescriptor$5 = objectGetOwnPropertyDescriptor$1.f; // `Reflect.deleteProperty` method
// https://tc39.github.io/ecma262/#sec-reflect.deleteproperty
...
_export$1({
  ...
  deleteProperty: function deleteProperty(target, propertyKey) {
    var descriptor = getOwnPropertyDescriptor$5(anObject$1(target), propertyKey);
    return descriptor && !descriptor.configurable ? false : delete target[propertyKey];
  }
});
  ...
  Object.defineProperty(target, key, {
    ...
    set: function set(value) {
      if (observerMap && curValue !== value) {
        ...
        try {
          for (var _iterator = Object.getOwnPropertySymbols(observerMap)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var s = _step.value;
...
/*#__PURE__*/
function () {
  function _default(dbName, storeName, keyPath) {
    var _this2 = this;
  ...
  _createClass(_default, [{
    key: "createDB",
    value: function createDB(dbName, storeName, keyPath) {
    ...
    key: "checkdbStore",
    value: function () {
      var _checkdbStore = _asyncToGenerator$1(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return this.createDB(this.dbName, this.storeName, this.keyPath);
      ...
      function checkdbStore() {
        return _checkdbStore.apply(this, arguments);
      }
    ...
    key: "getData4DB",
    value: function () {
      var _getData4DB = _asyncToGenerator$1(
      /*#__PURE__*/
      regenerator$1.mark(function _callee2(key) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", new Error('缺少入参key值'));
              ...
              case 2:
                ...
                return _context2.abrupt("return", new Error('请先创建indexDB'));
              ...
              case 4:
                ...
                _context2.next = 7;
                return observer(this, 'isPending');
      ...
      function getData4DB(_x) {
        return _getData4DB.apply(this, arguments);
      }
    ...
    key: "addData4DB",
    value: function () {
      var _addData4DB = _asyncToGenerator$1(
      /*#__PURE__*/
      regenerator$1.mark(function _callee3(key, data) {
        var _this4 = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", new Error('缺少入参key值'));
              ...
              case 2:
                ...
                return _context3.abrupt("return", new Error('缺少入参data'));
              ...
              case 4:
                ...
                return _context3.abrupt("return", new Error('请先创建indexDB'));
              ...
              case 13:
                ...
                return _context3.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  var dataTemp = _defineProperty$1({}, _this4.keyPath, key);
      ...
      function addData4DB(_x2, _x3) {
        return _addData4DB.apply(this, arguments);
      }
    ...
    key: "removeItem",
    value: function removeItem(cacheName) {
      var _this5 = this;

      if (!this.db || !this.db.objectStoreNames.contains(this.storeName)) { return; }
      return new Promise(function (resolve) {
        var request = _this5.db.transaction([_this5.storeName], 'readwrite').objectStore(_this5.storeName).delete(cacheName);
...
var createAjax = function createAjax(option) {
  ...
  cacheDB = new _default('tops-ajax', 'pkg', 'requestmd5');
